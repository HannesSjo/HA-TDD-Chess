...
public class ChessboardTests {
    ...
    public void testStartingBoardKingsInTheRightSpot() {
        final Chessboard chessboard = ChessboardImpl.startingBoard();
        Assertions.assertEquals(new King(Color.BLACK, null), chessboard.getPieceAt(new Square(4, 0)));
        Assertions.assertEquals(new King(Color.WHITE, null), chessboard.getPieceAt(new Square(4, 7)));
    }

    @Test
    public void testStartingBoardQueensInTheRightSpot() {
        final Chessboard chessboard = ChessboardImpl.startingBoard();
        Assertions.assertEquals(new Queen(Color.BLACK, null), chessboard.getPieceAt(new Square(3, 0)));
        Assertions.assertEquals(new Queen(Color.WHITE, null), chessboard.getPieceAt(new Square(3, 7)));
    }
